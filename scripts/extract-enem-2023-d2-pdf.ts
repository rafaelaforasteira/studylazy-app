/**
 * Extract raw text from ENEM 2023 D2 Caderno 5 Amarelo prova PDF by page.
 * Run: npx tsx scripts/extract-enem-2023-d2-pdf.ts
 */
...
const OUT_DIR = path.join(
  process.cwd(),
  'docs/imports/enem/2023/day2/extracted'
);
